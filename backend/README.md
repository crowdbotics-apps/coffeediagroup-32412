...
## Project Structure
    ...
    ├── coffeediagroup_32412  # Django project configurations
...
1. Clone this repo and `cd coffeediagroup_32412`
...
2. Clone this repo and `cd coffeediagroup_32412`
